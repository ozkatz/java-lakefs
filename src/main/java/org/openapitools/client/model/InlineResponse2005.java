...
public class InlineResponse2005 {
  ...
  **/
  ...
  public InlineResponse2005 results(List<Repository> results) {
    
    this.results = results;
    return this;
  }

  public InlineResponse2005 addResultsItem(Repository resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Repository>();
    }
