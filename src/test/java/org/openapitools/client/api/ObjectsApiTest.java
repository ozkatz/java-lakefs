...
public class ObjectsApiTest {
    ...
    public void listObjectsTest() throws ApiException {
        ...
        String after = null;
        Integer amount = null;
        InlineResponse2009 response = api.listObjects(repository, ref, prefix, after, amount);
    ...
    public void uploadObjectTest() throws ApiException {
        ...
        File content = null;
        ObjectStats response = api.uploadObject(repository, branch, path, storageClass, content);
